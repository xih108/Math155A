...
void MySetupLights()
{
    ...
    myLights[1].AmbientColor.Set(0.2, 0.2, 0.2);    // Yellow color
    myLights[1].DiffuseColor.Set(0.8, 0.8, 0.8);    // Yellow
    myLights[1].SpecularColor.Set(0.9, 0.9, 0.9);   // White
    ...
    myLights[3].DiffuseColor.Set(0.7, 0.7, 0.7);      // Very light gray
...
void LoadAllLights() 
{
    ...
    myLights[3].SetPosition(viewMatrix, VectorR3(5.0, 6.0, 4));
    myLights[3].SetSpotlightDirection(viewMatrix, VectorR3(0.0, -1.0, -0.4));
